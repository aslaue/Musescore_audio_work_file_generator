...
class Fenetre_3:
    def __init__(self,GUI_parameters,len_list_voix_accompagnement, master=None):
        self.Fenetre = tk.Tk()
        self.Fenetre.title('Fenêtre 3 - Renseignements des volumes pour les fichiers de travail')
        ...
        if len_list_voix_accompagnement==0:
        ...
        self.label3 = ttk.Label(self.Fenetre, text="Il est possible d'affiner les réglages de volume à la fenêtre suivante")
