...
class Fenetre_simple:
	...
	def __init__(self, master=None):
		...
		scrollbar = ttk.Scrollbar(self.Fenetre, orient='vertical', command=self.listbox1.yview)
		self.listbox1['yscrollcommand'] = scrollbar.set

		self.Fenetre.grid_columnconfigure(0, weight=1)
		self.Fenetre.grid_rowconfigure(0, weight=1)
		self.listbox1.grid(row=0, column=0, sticky=tk.EW)
